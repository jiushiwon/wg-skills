  ...
  <view class="page-container">
    ...
    <view class="info-section">
      ...
      <view class="title-row">
        ...
        <view class="favorite-btn" :class="{ active: isFavorite }" @click="toggleFavorite">
          <view class="icon-svg">
            <svg viewBox="0 0 24 24" :fill="isFavorite ? '#D4AF37' : 'none'" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <view class="service-section">
      <view class="service-item" v-for="(item, index) in services" :key="index">
        <view class="icon-svg icon-small" style="color: #D4AF37;">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
...
.coupon-item {
  padding: 4px 10px;
  background: linear-gradient(135deg, #16162A, #232340);
