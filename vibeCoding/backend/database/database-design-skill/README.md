...
AI（database-design-skill → references/base-schemas.md）：
...
具体数据库安装脚本在：`docs/vibeCoding/super-deploy-skills/database-install-skill/children/`
- MySQL → mysql-install-skill
- PostgreSQL → postgres-install-skill
- MongoDB → mongodb-install-skill
- Redis → redis-install-skill
