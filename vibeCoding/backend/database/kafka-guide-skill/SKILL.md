---
name: kafka-guide-skill
description: Kafka 消息队列学习与选型指南。面向需要了解 Kafka 的开发者，提供核心概念、安装部署、生产者/消费者模型、消息可靠性、与业务场景匹配推荐、设计规则等（不含具体框架集成，Spring Boot 集成请用 springboot-kafka-module-skill，Python 集成请用 python-kafka-module-skill）。触发词："Kafka 学习"、"Kafka 入门"、"Kafka 选型"、"Kafka 消息队列"、"Kafka 概念"、"Kafka 安装"、"消息队列选型"。
---
