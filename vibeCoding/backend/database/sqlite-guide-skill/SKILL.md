---
name: sqlite-guide-skill
description: SQLite 学习与选型指南。面向需要了解 SQLite 的开发者，提供核心概念、安装配置、CRUD、事务处理、并发访问、与业务场景匹配推荐等（不含具体框架集成）。触发词："SQLite 学习"、"SQLite 入门"、"SQLite 选型"、"轻量数据库"、"嵌入式数据库"、"sqlite 概念"。
---
