---
name: mysql-guide-skill
description: MySQL 学习与选型指南。面向需要了解 MySQL 的开发者，提供核心概念、安装部署、表结构设计、索引优化、事务原理、主从复制、与业务场景匹配推荐等（不含具体框架集成）。触发词："MySQL 学习"、"MySQL 入门"、"MySQL 选型"、"MySQL 索引"、"MySQL 事务"、"MySQL 设计"、"SQL 优化"。
---
