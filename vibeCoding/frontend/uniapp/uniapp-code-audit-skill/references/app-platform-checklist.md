...
| 检查项 | 风险等级 | 风险描述 | 判定依据 | 参考标准 | 检测命令 |
|--------|----------|----------|----------|----------|----------|
| 证书/签名配置泄露 | P0 | App 签名私钥泄露风险 | 打包配置/文档中泄露 keystore 密码或签名文件 | 通用安全规范 | `find . -type f \( -name '*.keystore' -o -name '*.jks' -o -name '*.p12' \) -not -path '*/node_modules/*' -not -path '*/dist/*' -not -path '*/unpackage/*'`；同时检查 `android/app/build.gradle` 与 `ios/Podfile` 是否误提交密码 |
