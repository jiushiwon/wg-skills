...
.dash-page--dark .dash-header__title {
  color: #e2e8f0;
}
.dash-page--dark .dash-header__subtitle {
  color: #94a3b8;
}
.dash-page--dark .dash-table {
  color: #e2e8f0;
}
.dash-page--dark .dash-table th {
  background: #0d1424;
  color: #94a3b8;
}
.dash-page--dark .dash-table td {
  border-color: #1f2937;
}
...
.dash-page--bigscreen .dash-header__subtitle {
  color: #8899bb;
}
.dash-page--bigscreen .dash-table {
  color: #c0ccdd;
}
...
.dash-page--bigscreen .dash-table td {
...
.dash-page--bigscreen .dash-chart-card,
.dash-page--bigscreen .dash-activity-card {
  box-shadow: 0 0 0 1px rgba(0, 212, 255, 0.1);
}
...
.dash-page--glass .dash-header__title {
  color: #e2e8f0;
}
.dash-page--glass .dash-header__subtitle {
  color: #94a3b8;
}
