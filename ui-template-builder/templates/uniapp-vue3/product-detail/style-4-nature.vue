  ...
  <view class="page-container">
    ...
    <view class="info-section">
      ...
      <view class="title-row">
        ...
        <view class="favorite-btn" :class="{ active: isFavorite }" @click="toggleFavorite">
          <view class="icon-svg">
            <svg viewBox="0 0 24 24" :fill="isFavorite ? '#2ECC71' : 'none'" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <view class="service-section">
      <view class="service-item" v-for="(item, index) in services" :key="index">
        <view class="icon-svg icon-small" style="color: #2ECC71;">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
...
.page-container {
  ...
  --cardRadius: 20px;
  --shadowMd: 0 4px 16px rgba(46, 204, 113, 0.15);
  min-height: 100vh;
  background: var(--bg);
  padding-bottom: 90px;
}
...
.btn-buy {
  background: linear-gradient(135deg, #2ECC71 0%, #4ADE80 100%);
}
